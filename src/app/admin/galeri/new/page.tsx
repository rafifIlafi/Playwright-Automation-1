...
export default function NewGaleri() {
  ...
  const handleSave = async () => {
    if (!judul || !gambar) {
      setError('Judul and gambar wajib diisi')
      return
    }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto p-4 md:p-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Add New Galeri Item</h2>
          <p className="text-foreground/60">Fill in the form below to add a new galeri item</p>
        </div>

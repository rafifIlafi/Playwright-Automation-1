...
test('TS-LOGIN-003', async ({ page }, testInfo) => {
  ...
  // ==========================
  // Mengisi Username (Invalid)
  // ==========================
  await page.getByRole('textbox', {
    name: 'Enter your username'
  }).fill('adminSalah');

  await Evidence.screenshot(page, testInfo, '02-invalid-username');

  // ==========================
  // Mengisi Password (Valid)
  // ==========================
  await page.getByRole('textbox', {
    name: 'Enter your password'
  }).fill('admin123');

  await Evidence.screenshot(page, testInfo, '03-valid-password');

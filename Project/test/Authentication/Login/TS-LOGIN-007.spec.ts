...
test('TS-LOGIN-007', async ({ page }, testInfo) => {
  ...
  // ==========================
  // Mengisi Username SQL Injection
  // ==========================
  await page.getByRole('textbox', {
    name: 'Enter your username'
  }).fill("' OR '1'='1");

  await Evidence.screenshot(page, testInfo, '02-sql-username');

  // ==========================
  // Mengisi Password SQL Injection
  // ==========================
  await page.getByRole('textbox', {
    name: 'Enter your password'
  }).fill("' OR '1'='1");

  await Evidence.screenshot(page, testInfo, '03-sql-password');
